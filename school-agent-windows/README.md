...
> [`school-agent-mac/`](../school-agent-mac). The two are independent —
> neither depends on the other, and neither needs the other to be
> installed. Take this folder on its own and it works.
